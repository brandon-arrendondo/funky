"""
Invoke tasks for funky development.
...
# A semver core like 0.4.1 (no pre-release / build metadata).
SEMVER = r"\d+\.\d+\.\d+"
...
def bump_version(c, new_version=None):
    ...
    Args:
        new_version: Target version string, e.g. 0.5.0 (no leading 'v').
    """
